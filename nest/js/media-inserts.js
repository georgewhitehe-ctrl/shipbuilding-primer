(function () {
  const media = {
    "classics.html": [
      ...
      ["s42", "human-welding-2.mp4", "人工焊接动作与节拍", "不同焊接姿态、操作节拍和现场修正体现了工艺经验的多样性，可作为自动化边界设计的参考。", true],
      ...
      ["s45", "robotic-machine-tending.jpeg", "机器人机床上下料", "机器人与机床联动需要统一任务身份、抓取位姿、程序状态和完工反馈。"],
      ["s46", "welding-detail.jpeg", "焊缝质量数据", "焊缝外观、热输入和缺陷记录需要绑定零件、设备与工艺版本，才能用于训练。"],
      ["s46", "robotic-welding-cell.jpeg", "机器人焊接单元", "焊接单元把工装、机器人、焊机与安全系统组合成可验证、可复制的自动化对象。"],
    ...
    "shipyards.html": [
      ...
      ["s25", "cnc-plasma-shipyard-3.mp4", "船厂钢板切割作业", "另一组现场切割过程用于观察设备节拍、热影响和切割后零件组织方式。", true],
      ...
      ["s27", "marine-fabrication-2.jpeg", "分段装配现场", "分段装配中的定位、临时支撑和偏差应形成结构化的现场反馈。"],
      ...
      ["s32", "marine-fabrication-3.jpeg", "复杂船体结构制造", "复杂结构的工序状态和质量证据需要沿船号、分段与零件层级逐级追踪。"],
    ...
    "ai-manufacturing.html": [
      ...
      ["s75", "robotic-welding-shipbuilding-2.mp4", "机器人焊接的现场验证", "模型建议需要经过影子运行、小批试产和质量复核，才能进入受控执行阶段。", true],
      ["s76", "precision-in-motion.jpeg", "现场技能与数字集成", "将工程师的操作判断、设备状态和质量结果关联起来，才能持续评估模型效果。"],
      ...
      ["s132", "ddcs-controller.jpeg", "控制器职责边界", "控制器维持确定性运动与联锁，AI平台通过受控接口提供预测、推荐和优化。"]
    ],
    "industry-agents.html": [
      ...
      ["section-4-2", "fanuc-r2000.jpeg", "FANUC工业机器人本体", "高负载机器人和控制系统的装机基础，使FANUC具备连接任务层智能与现场执行的优势。"],
      ...
      ["section-8-2", "industrial-robot-friend.jpeg", "设备侧执行资产", "机器人、机床和工艺包组成华工可控制的执行资产，也是建立差异化数据闭环的基础。"],
      ...
      ["section-12-3", "robotic-welding-shipbuilding-4.mp4", "焊接智能体的数据回流", "执行过程、焊缝质量与人工处置结果应回流到工艺库和模型评测体系。", true],
